...
# En el tiempo 516 hubo una caida en la temperatura, en la corriente y una subida 
...
# Las anomalias observadas en la series de tiempo se explican con una desconexion 
# entre las diferentes conexiones del motor trifasico, como se puede observar entre
# current_D y las demas.
